...
public class CanvasWindow {
    ...
    /**
     * Save the image on the canvas window with its current looking into a png file.
     * @param filename The file name you want for your saved image.
     * @param targetImage The bufferimage of the image you want to save;
     *                    This is mainly for getting the size of the image.
     */
    public void saveImage(String filename, BufferedImage targetImage) {
        BufferedImage bImg = new BufferedImage(targetImage.getWidth(),
